<template>
    <div id="details-tab" class="flex-1 rounded-md bg-gray-100 shadow-2xl p-10 pl-0 pt-6">
        ...
        <div class="large-fields-cont flex bg-white rounded-md mb-4 ml-10">
            <div class="flex-1 p-4">
                <div class="field-container h-14">
        ...
        <div class="large-fields-cont flex bg-white rounded-md ml-10">
            <div class="flex-1 p-4">
                <div class="field-container h-14">
