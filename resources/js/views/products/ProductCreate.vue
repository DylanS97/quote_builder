    ...
    <div class="width-full">
        ...
        <div class="max-w-7xl mx-auto p-10">
            <form @submit.prevent="createProduct" class="p-6 bg-white shadow-2xl rounded-md" method="post">
                <div class="flex mt-4">
                    <div class="flex-1 px-4 mb-4">
                        <div class="field-container w-100 h-14">
                            <input v-model="name" type="text" id="name" placeholder=" " class="field rounded-md font-light">
                ...
                <div class="prod-create-edit-btns p-4">
                    <button @click="goBack" class="w-32 py-2 bg-red-500 text-white rounded-md mr-8">Cancel</button>
